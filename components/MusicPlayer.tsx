...
export default function MusicPlayer() {
  ...
  return (
    <ViewTransition name="music-player">
      <div className="fixed bottom-0 left-0 right-0 z-50" data-url={pathname}>
            ...
            <div className="flex gap-5 items-center">
              ...
              >
                ...
                {showPlaylist && playlist.length > 0 && (
                  <div className="absolute bottom-full right-0 mb-2 w-96 max-h-96 overflow-y-auto rounded-2xl">
                    {/* Liquid glass background with gradient - matching player style */}
                    <LiquidGlass className="rounded-2xl shadow-[0_-10px_40px_rgba(0,0,0,0.5)] border border-white/50 overflow-hidden bg-white">
                      {/* Additional glass layer for depth - darker for contrast */}
                      <div className="absolute inset-0 bg-black/40 rounded-2xl overflow-hidden"></div>
...
function LiquidGlass({
  ...
  return (
    <div
      className={twMerge(
        "relative backdrop-blur-[25px] bg-linear-to-br from-purple-600/40 via-pink-600/40 to-blue-600/40 border-t-2 border-white/30 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]",
        className
      )}
    >
      {children}
