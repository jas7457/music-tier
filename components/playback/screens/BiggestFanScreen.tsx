  ...
  if (!biggestFan) {
    return (
      <div className="h-full flex flex-col items-center justify-center p-8 text-white">
        <p className="text-2xl text-purple-300">No fan data available</p>
      </div>
    );
  }

  const { user, points, songs } = biggestFan;
  ...
  return (
    <div className="h-full flex items-center p-8 text-white">
      <div className="w-full flex flex-col gap-4 max-h-full">
        ...
        >
          <h2 className="text-center">You two must really like each other</h2>
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-purple-200 mb-2">gave you</p>
            <div className="text-4xl font-bold">
              <OutlinedText strokeColor={NEON_COLORS.LimeGreen} strokeWidth={2}>
                {points} points
              </OutlinedText>
            </div>
          </div>
