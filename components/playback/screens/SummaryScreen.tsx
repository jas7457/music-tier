      ...
      if (firstTake) {
        ...
        cards.push({
          ...
          description: (
            <div>
              <p>
                You shared a total of {firstTake.totalPoints.toString()} points
                with this user. A true musical connection!
              </p>
            </div>
          ),
        });
