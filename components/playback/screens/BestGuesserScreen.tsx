...
export function BestGuesserScreen({ playback, isActive }: PlaybackScreenProps) {
  const stat = playback.bestGuesser;
  ...
  return (
    <div className="h-full flex items-center p-8 text-white">
      <div className="w-full flex flex-col gap-4 max-h-full">
        ...
        >
          <h2 className="text-center">Are you a psychic?</h2>
          <p className="text-2xl text-purple-300 text-center">Best Guesser</p>
        </div>
        ...
        >
          ...
          <div className="text-center">
            ...
            <div className="text-4xl font-bold">
              ...
              <OutlinedText strokeColor="#10b981" strokeWidth={2}>
